 ...
 *
 *  stripped BCD,
 *  removed SED,CLD opcodes,
 *  added full 16-bit IR decoding,
 *  added Arlet's updates from 5 months ago
 ...
 *  added WDC65C02 PHX, PHY, PLX, PLY opcodes
 *  added WDC65C02 INC[A], DEC[A] opcodes, also INC[B..Q], DEC[B..Q]
 *  added W index register with same addressing modes as Y
 *  added relocatable stack and zero pages
 *  added Transfer opcodes for stack and zero pages pointers
 *  added index transfer opcodes for W. That's it for .b CORE!
...
parameter pQAWXYS_INIT = "REGFILE_INIT.COE";    // Register file initialization
...
initial
	begin
		zp_reg = 0;
		sp_reg = 0; //shoud be same value as QAWXYS[SEL_SPP] for proper simulation
	end
...
always @*
	...
	BRK2: 		PC_temp = res ? 32'hffff_fffc
                              : NMI_edge ? 32'hffff_fffa
                                         : 32'hffff_fffe; // width should be parameterised
...
initial
    $readmemh(pQAWXYS_INIT, QAWXYS, 0, 31);
    ...
    if( reset )
        ...
        DECODE  : 
            casex ( IR[15:0] )  							// decode all 16 bits:
                //
                //  IR[15:12]: used for reg [3:0] E_Reg (Shift Distance Register) on all <shift,rotate> opcodes only.
...
always @(posedge clk)
     if( state == DECODE && RDY )
		...
		16'b0000_0000_00x0_0111,	// TZ[A], TS[A]
		...
		16'bxx00_xx00_0xx1_0010,	// ORA[A..Q]op[A] (zp)w, AND[A..Q]op[A] (zp)w, ADC[A..Q]op[A] (zp)w
		16'bxx00_xx00_0xx1_1011,	// ORA[A..Q]op[A] aw, AND[A..Q]op[A] aw, ADC[A..Q]op[A] aw
		...
		16'b0000_0001_00x0_0111,	// TZ[B], TS[B]
		...
		16'bxx00_xx01_0xx1_0010,	// ORA[A..Q]op[B] (zp)w, AND[A..Q]op[B] (zp)w, ADC[A..Q]op[B] (zp)w
		16'bxx00_xx01_0xx1_1011,	// ORA[A..Q]op[B] aw, AND[A..Q]op[B] aw, ADC[A..Q]op[B] aw
		...
		16'b0000_0010_00x0_0111,	// TZ[C], TS[C]
		...
		16'bxx00_xx10_0xx1_0010,	// ORA[A..Q]op[C] (zp)w, AND[A..Q]op[C] (zp)w, ADC[A..Q]op[C] (zp)w
		16'bxx00_xx10_0xx1_1011,	// ORA[A..Q]op[C] aw, AND[A..Q]op[C] aw, ADC[A..Q]op[C] aw
		...
		16'b0000_0011_00x0_0111,	// TZ[D], TS[D]
		...
		16'bxx00_xx11_0xx1_0010,	// ORA[A..Q]op[D] (zp)w, AND[A..Q]op[D] (zp)w, ADC[A..Q]op[D] (zp)w
		16'bxx00_xx11_0xx1_1011,	// ORA[A..Q]op[D] aw, AND[A..Q]op[D] aw, ADC[A..Q]op[D] aw
		...
		16'b0001_0000_00x0_0111,	// TZ[E], TS[E]
		...
		16'bxx01_xx00_0xx1_0010,	// ORA[A..Q]op[E] (zp)w, AND[A..Q]op[E] (zp)w, ADC[A..Q]op[E] (zp)w
		16'bxx01_xx00_0xx1_1011,	// ORA[A..Q]op[E] aw, AND[A..Q]op[E] aw, ADC[A..Q]op[E] aw
		16'bxx01_xx00_1111_0010,	// SBC[A..Q]op[E] (zp)y
		16'bxx01_xx00_1111_1011,	// SBC[A..Q]op[E] aw
		16'b0101_0000_0010_x100:	// BIT[E] zp, a
		      dst_reg <= SEL_E;

		16'b0001_0001_00x0_0111,	// TZ[F], TS[F]
		...
		16'bxx01_xx01_0xx1_0010,	// ORA[A..Q]op[F] (zp)w, AND[A..Q]op[F] (zp)w, ADC[A..Q]op[F] (zp)w
		16'bxx01_xx01_0xx1_1011,	// ORA[A..Q]op[F] aw, AND[A..Q]op[F] aw, ADC[A..Q]op[F] aw
		16'bxx01_xx01_1111_0010,	// SBC[A..Q]op[F] (zp)y
		16'bxx01_xx01_1111_1011,	// SBC[A..Q]op[F] aw
		16'b0101_0101_0010_x100:	// BIT[F] zp, a
		      dst_reg <= SEL_F;

		16'b0001_0010_00x0_0111,	// TZ[G], TS[G]
		...
		16'bxx01_xx10_0xx1_0010,	// ORA[A..Q]op[G] (zp)w, AND[A..Q]op[G] (zp)w, ADC[A..Q]op[G] (zp)w
		16'bxx01_xx10_0xx1_1011,	// ORA[A..Q]op[G] aw, AND[A..Q]op[G] aw, ADC[A..Q]op[G] aw
		16'bxx01_xx10_1111_0010,	// SBC[A..Q]op[G] (zp)y
		16'bxx01_xx10_1111_1011,	// SBC[A..Q]op[G] aw
		16'b0101_1010_0010_x100:	// BIT[G] zp, a
		      dst_reg <= SEL_G;

		16'b0001_0011_00x0_0111,	// TZ[H], TS[H]
		...
		16'bxx01_xx11_0xx1_0010,	// ORA[A..Q]op[H] (zp)w, AND[A..Q]op[H] (zp)w, ADC[A..Q]op[H] (zp)w
		16'bxx01_xx11_0xx1_1011,	// ORA[A..Q]op[H] aw, AND[A..Q]op[H] aw, ADC[A..Q]op[H] aw
		16'bxx01_xx11_1111_0010,	// SBC[A..Q]op[H] (zp)y
		16'bxx01_xx11_1111_1011,	// SBC[A..Q]op[H] aw
		16'b0101_1111_0010_x100:	// BIT[H] zp, a
		      dst_reg <= SEL_H;

		16'b0010_0000_00x0_0111,	// TZ[I], TS[I]
		...
		16'bxx10_xx00_0xx1_0010,	// ORA[A..Q]op[I] (zp)w, AND[A..Q]op[I] (zp)w, ADC[A..Q]op[I] (zp)w
		16'bxx10_xx00_0xx1_1011,	// ORA[A..Q]op[I] aw, AND[A..Q]op[I] aw, ADC[A..Q]op[I] aw
		16'bxx10_xx00_1111_0010,	// SBC[A..Q]op[I] (zp)y
		16'bxx10_xx00_1111_1011,	// SBC[A..Q]op[I] aw
		16'b1010_0000_0010_x100:	// BIT[I] zp, a
		      dst_reg <= SEL_I;

		16'b0010_0001_00x0_0111,	// TZ[J], TS[J]
		...
		16'bxx10_xx01_0xx1_0010,	// ORA[A..Q]op[J] (zp)w, AND[A..Q]op[J] (zp)w, ADC[A..Q]op[J] (zp)w
		16'bxx10_xx01_0xx1_1011,	// ORA[A..Q]op[J] aw, AND[A..Q]op[J] aw, ADC[A..Q]op[J] aw
		16'bxx10_xx01_1111_0010,	// SBC[A..Q]op[J] (zp)y
		16'bxx10_xx01_1111_1011,	// SBC[A..Q]op[J] aw
		16'b1010_0101_0010_x100:	// BIT[J] zp, a
		      dst_reg <= SEL_J;

		16'b0010_0010_00x0_0111,	// TZ[K], TS[K]
		...
		16'bxx10_xx10_0xx1_0010,	// ORA[A..Q]op[K] (zp)w, AND[A..Q]op[K] (zp)w, ADC[A..Q]op[K] (zp)w
		16'bxx10_xx10_0xx1_1011,	// ORA[A..Q]op[K] aw, AND[A..Q]op[K] aw, ADC[A..Q]op[K] aw
		16'bxx10_xx10_1111_0010,	// SBC[A..Q]op[K] (zp)y
		16'bxx10_xx10_1111_1011,	// SBC[A..Q]op[K] aw
		16'b1010_1010_0010_x100:	// BIT[K] zp, a
		      dst_reg <= SEL_K;

		16'b0010_0011_00x0_0111,	// TZ[L], TS[L]
		...
		16'bxx10_xx11_0xx1_0010,	// ORA[A..Q]op[L] (zp)w, AND[A..Q]op[L] (zp)w, ADC[A..Q]op[L] (zp)w
		16'bxx10_xx11_0xx1_1011,	// ORA[A..Q]op[L] aw, AND[A..Q]op[L] aw, ADC[A..Q]op[L] aw
		16'bxx10_xx11_1111_0010,	// SBC[A..Q]op[L] (zp)y
		16'bxx10_xx11_1111_1011,	// SBC[A..Q]op[L] aw
		16'b1010_1111_0010_x100:	// BIT[L] zp, a
		      dst_reg <= SEL_L;

		16'b0011_0000_00x0_0111,	// TZ[M], TS[M]
		...
		16'bxx11_xx00_0xx1_0010,	// ORA[A..Q]op[M] (zp)w, AND[A..Q]op[M] (zp)w, ADC[A..Q]op[M] (zp)w
		16'bxx11_xx00_0xx1_1011,	// ORA[A..Q]op[M] aw, AND[A..Q]op[M] aw, ADC[A..Q]op[M] aw
		16'bxx11_xx00_1111_0010,	// SBC[A..Q]op[M] (zp)y
		16'bxx11_xx00_1111_1011,	// SBC[A..Q]op[M] aw
		16'b1111_0000_0010_x100:	// BIT[M] zp, a
		      dst_reg <= SEL_M;

		16'b0011_0001_00x0_0111,	// TZ[N], TS[N]
		...
		16'bxx11_xx01_0xx1_0010,	// ORA[A..Q]op[N] (zp)w, AND[A..Q]op[N] (zp)w, ADC[A..Q]op[N] (zp)w
		16'bxx11_xx01_0xx1_1011,	// ORA[A..Q]op[N] aw, AND[A..Q]op[N] aw, ADC[A..Q]op[N] aw
		16'bxx11_xx01_1111_0010,	// SBC[A..Q]op[N] (zp)y
		16'bxx11_xx01_1111_1011,	// SBC[A..Q]op[N] aw
		16'b1111_0101_0010_x100:	// BIT[N] zp, a
		      dst_reg <= SEL_N;

		16'b0011_0010_00x0_0111,	// TZ[O], TS[O]
		...
		16'bxx11_xx10_0xx1_0010,	// ORA[A..Q]op[O] (zp)w, AND[A..Q]op[O] (zp)w, ADC[A..Q]op[O] (zp)w
		16'bxx11_xx10_0xx1_1011,	// ORA[A..Q]op[O] aw, AND[A..Q]op[O] aw, ADC[A..Q]op[O] aw
		16'bxx11_xx10_1111_0010,	// SBC[A..Q]op[O] (zp)y
		16'bxx11_xx10_1111_1011,	// SBC[A..Q]op[O] aw
		16'b1111_1010_0010_x100:	// BIT[O] zp, a
		      dst_reg <= SEL_O;

		16'b0011_0011_00x0_0111,	// TZ[Q], TS[Q]
		...
		16'bxx11_xx11_0xx1_0010,	// ORA[A..Q]op[Q] (zp)w, AND[A..Q]op[Q] (zp)w, ADC[A..Q]op[Q] (zp)w
		16'bxx11_xx11_0xx1_1011,	// ORA[A..Q]op[Q] aw, AND[A..Q]op[Q] aw, ADC[A..Q]op[Q] aw
...
always @(posedge clk)
     if( state == DECODE && RDY )
		...
		16'b0000_0000_00x1_0111,	// T[A]Z, T[A]S
		...
		16'b00xx_00xx_0xx1_0010,	// ORA[A]op[A..Q] (zp)w, AND[A]op[A..Q] (zp)w, ADC[A]op[A..Q] (zp)w
		16'b00xx_00xx_0xx1_1011,	// ORA[A]op[A..Q] aw, AND[A]op[A..Q] aw, ADC[A]op[A..Q] aw
		...
		16'b00xx_01xx_0xx1_0010,	// ORA[B]op[A..Q] (zp)w, AND[B]op[A..Q] (zp)w, ADC[B]op[A..Q] (zp)w
		16'b00xx_01xx_0xx1_1011,	// ORA[B]op[A..Q] aw, AND[B]op[A..Q] aw, ADC[B]op[A..Q] aw
		...
		16'b0000_1000_00x1_0111,	// T[C]Z, T[C]S
		...
		16'b00xx_10xx_0xx1_0010,	// ORA[C]op[A..Q] (zp)w, AND[C]op[A..Q] (zp)w, ADC[C]op[A..Q] (zp)w
		16'b00xx_10xx_0xx1_1011,	// ORA[C]op[A..Q] aw, AND[C]op[A..Q] aw, ADC[C]op[A..Q] aw
		...
		16'b0000_1100_00x1_0111,	// T[D]Z, T[D]S
		...
		16'b00xx_11xx_0xx1_0010,	// ORA[D]op[A..Q] (zp)w, AND[A]op[A..Q] (zp)w, ADC[D]op[A..Q] (zp)w
		16'b00xx_11xx_0xx1_1011,	// ORA[D]op[A..Q] aw, AND[A]op[A..Q] aw, ADC[D]op[A..Q] aw
		...
		16'b0100_0000_00x1_0111,	// T[E]Z, T[E]S
		...
		16'b01xx_00xx_0xx1_0010,	// ORA[E]op[A..Q] (zp)w, AND[E]op[A..Q] (zp)w, ADC[E]op[A..Q] (zp)w
		16'b01xx_00xx_0xx1_1011,	// ORA[E]op[A..Q] aw, AND[E]op[A..Q] aw, ADC[E]op[A..Q] aw
		16'b01xx_00xx_1111_0010,	// SBC[E]op[A..Q] (zp)y
		16'b01xx_00xx_1111_1011,	// SBC[E]op[A..Q] aw
		16'b0101_0000_0010_x100:	// BIT[E] zp, a
				src_reg <= SEL_E;

		16'b0100_0100_00x1_0111,	// T[F]Z, T[F]S
		...
		16'b01xx_01xx_0xx1_0010,	// ORA[F]op[A..Q] (zp)w, AND[F]op[A..Q] (zp)w, ADC[F]op[A..Q] (zp)w
		16'b01xx_01xx_0xx1_1011,	// ORA[F]op[A..Q] aw, AND[F]op[A..Q] aw, ADC[F]op[A..Q] aw
		16'b01xx_01xx_1111_0010,	// SBC[F]op[A..Q] (zp)y
		16'b01xx_01xx_1111_1011,	// SBC[F]op[A..Q] aw
		16'b0101_0101_0010_x100:	// BIT[F] zp, a
				src_reg <= SEL_F;

		16'b0100_1000_00x1_0111,	// T[G]Z, T[G]S
		...
		16'b01xx_10xx_0xx1_0010,	// ORA[G]op[A..Q] (zp)w, AND[G]op[A..Q] (zp)w, ADC[G]op[A..Q] (zp)w
		16'b01xx_10xx_0xx1_1011,	// ORA[G]op[A..Q] aw, AND[G]op[A..Q] aw, ADC[G]op[A..Q] aw
		16'b01xx_10xx_1111_0010,	// SBC[G]op[A..Q] (zp)y
		16'b01xx_10xx_1111_1011,	// SBC[G]op[A..Q] aw
		16'b0101_1010_0010_x100:	// BIT[G] zp, a
				src_reg <= SEL_G;

		16'b0100_1100_00x1_0111,	// T[H]Z, T[H]S
		...
		16'b01xx_11xx_0xx1_0010,	// ORA[H]op[A..Q] (zp)w, AND[H]op[A..Q] (zp)w, ADC[H]op[A..Q] (zp)w
		16'b01xx_11xx_0xx1_1011,	// ORA[H]op[A..Q] aw, AND[H]op[A..Q] aw, ADC[H]op[A..Q] aw
		16'b01xx_11xx_1111_0010,	// SBC[H]op[A..Q] (zp)y
		16'b01xx_11xx_1111_1011,	// SBC[H]op[A..Q] aw
		16'b0101_1111_0010_x100:	// BIT[H] zp, a
				src_reg <= SEL_H;

		16'b1000_0000_00x1_0111,	// T[I]Z, T[I]S
		...
		16'b10xx_00xx_0xx1_0010,	// ORA[I]op[A..Q] (zp)w, AND[I]op[A..Q] (zp)w, ADC[I]op[A..Q] (zp)w
		16'b10xx_00xx_0xx1_1011,	// ORA[I]op[A..Q] aw, AND[I]op[A..Q] aw, ADC[I]op[A..Q] aw
		16'b10xx_00xx_1111_0010,	// SBC[I]op[A..Q] (zp)y
		16'b10xx_00xx_1111_1011,	// SBC[I]op[A..Q] aw
		16'b1010_0000_0010_x100:	// BIT[I] zp, a
				src_reg <= SEL_I;

		16'b1000_0100_00x1_0111,	// T[J]Z, T[J]S
		...
		16'b10xx_01xx_0xx1_0010,	// ORA[J]op[A..Q] (zp)w, AND[J]op[A..Q] (zp)w, ADC[J]op[A..Q] (zp)w
		16'b10xx_01xx_0xx1_1011,	// ORA[J]op[A..Q] aw, AND[J]op[A..Q] aw, ADC[J]op[A..Q] aw
		16'b10xx_01xx_1111_0010,	// SBC[J]op[A..Q] (zp)y
		16'b10xx_01xx_1111_1011,	// SBC[J]op[A..Q] aw
		16'b1010_0101_0010_x100:	// BIT[J] zp, a
				src_reg <= SEL_J;

		16'b1000_1000_00x1_0111,	// T[K]Z, T[K]S
		...
		16'b10xx_10xx_0xx1_0010,	// ORA[K]op[A..Q] (zp)w, AND[K]op[A..Q] (zp)w, ADC[K]op[A..Q] (zp)w
		16'b10xx_10xx_0xx1_1011,	// ORA[K]op[A..Q] aw, AND[K]op[A..Q] aw, ADC[K]op[A..Q] aw
		16'b10xx_10xx_1111_0010,	// SBC[K]op[A..Q] (zp)y
		16'b10xx_10xx_1111_1011,	// SBC[K]op[A..Q] aw
		16'b1010_1010_0010_x100:	// BIT[K] zp, a
				src_reg <= SEL_K;

		16'b1000_1100_00x1_0111,	// T[L]Z, T[L]S
		...
		16'b10xx_11xx_0xx1_0010,	// ORA[L]op[A..Q] (zp)w, AND[L]op[A..Q] (zp)w, ADC[L]op[A..Q] (zp)w
		16'b10xx_11xx_0xx1_1011,	// ORA[L]op[A..Q] aw, AND[L]op[A..Q] aw, ADC[L]op[A..Q] aw
		16'b10xx_11xx_1111_0010,	// SBC[L]op[A..Q] (zp)y
		16'b10xx_11xx_1111_1011,	// SBC[L]op[A..Q] aw
		16'b1010_1111_0010_x100:	// BIT[L] zp, a
				src_reg <= SEL_L;

		16'b1100_0000_00x1_0111,	// T[M]Z, T[M]S
		...
		16'b11xx_00xx_0xx1_0010,	// ORA[M]op[A..Q] (zp)w, AND[M]op[A..Q] (zp)w, ADC[M]op[A..Q] (zp)w
		16'b11xx_00xx_0xx1_1011,	// ORA[M]op[A..Q] aw, AND[M]op[A..Q] aw, ADC[M]op[A..Q] aw
		16'b11xx_00xx_1111_0010,	// SBC[M]op[A..Q] (zp)y
		16'b11xx_00xx_1111_1011,	// SBC[M]op[A..Q] aw
		16'b1111_0000_0010_x100:	// BIT[M] zp, a
				src_reg <= SEL_M;

		16'b1100_0100_00x1_0111,	// T[N]Z, T[N]S
		...
		16'b11xx_01xx_0xx1_0010,	// ORA[N]op[A..Q] (zp)w, AND[N]op[A..Q] (zp)w, ADC[N]op[A..Q] (zp)w
		16'b11xx_01xx_0xx1_1011,	// ORA[N]op[A..Q] aw, AND[N]op[A..Q] aw, ADC[N]op[A..Q] aw
		16'b11xx_01xx_1111_0010,	// SBC[N]op[A..Q] (zp)y
		16'b11xx_01xx_1111_1011,	// SBC[N]op[A..Q] aw
		16'b1111_0101_0010_x100:	// BIT[N] zp, a
				src_reg <= SEL_N;

		16'b1100_1000_00x1_0111,	// T[O]Z, T[O]S
		...
		16'b11xx_10xx_0xx1_0010,	// ORA[O]op[A..Q] (zp)w, AND[O]op[A..Q] (zp)w, ADC[O]op[A..Q] (zp)w
		16'b11xx_10xx_0xx1_1011,	// ORA[O]op[A..Q] aw, AND[O]op[A..Q] aw, ADC[O]op[A..Q] aw
		16'b11xx_10xx_1111_0010,	// SBC[O]op[A..Q] (zp)y
		16'b11xx_10xx_1111_1011,	// SBC[O]op[A..Q] aw
		16'b1111_1010_0010_x100:	// BIT[O] zp, a
				src_reg <= SEL_O;

		16'b1100_1100_00x1_0111,	// T[Q]Z, T[Q]S
		...
		16'b11xx_11xx_0xx1_0010,	// ORA[Q]op[A..Q] (zp)w, AND[Q]op[A..Q] (zp)w, ADC[Q]op[A..Q] (zp)w
		16'b11xx_11xx_0xx1_1011,	// ORA[Q]op[A..Q] aw, AND[Q]op[A..Q] aw, ADC[Q]op[A..Q] aw
...
always @(posedge clk )
     if( state == DECODE && RDY )
     	casex( IR[15:0] )  			
		16'b00xx_00xx_1010_0xxx,	// LD[A..Q] zpx, zp, LDX #, zp, LDY #, zp, LDW zp
